...
ASSUMPTIONS: Tuple[Assumption, ...] = (
    ...
    Assumption(
        ...
        claim=(
            ...
            "resident (`retire <id>: settled, idle 60m` in 34 of 45 log lines, "
            "`idle 8h` in 5 just after a daemon start, 11-44m with "
            "`[low memory]` in 6; #350); `claude stop` on a `done` child ends its process "
